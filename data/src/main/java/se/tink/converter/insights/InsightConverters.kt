...
private fun convertType(type: String): InsightType =
    when (type) {
        ...
        "SINGLE_UNCATEGORIZED_TRANSACTION" -> InsightType.SINGLE_UNCATEGORIZED_TRANSACTION
        ...
        "WEEKLY_SUMMARY_EXPENSES_BY_DAY" -> InsightType.WEEKLY_SUMMARY_EXPENSES_BY_DAY
