...
public class SecuredClientDataStorage implements SharedPreferences, Clearable {

	private static final String TAG = "SecuredCDStorage";
	private static final String PREF_FILE_NAME = "SCDS_file";
	...
	private static SecuredClientDataStorage mInstance;

	private SecuredClientDataStorage(Context appContext)
		throws IOException, CertificateException, NoSuchAlgorithmException, KeyStoreException, UnrecoverableEntryException, InvalidAlgorithmParameterException, NoSuchPaddingException, InvalidKeyException, NoSuchProviderException {
	...
	public static void setRecoveryHandler(RecoveryHandler recoveryHandler) {
		SecuredClientDataStorage.mRecoveryHandler = recoveryHandler;
	}

	synchronized public static SecuredClientDataStorage getSharedInstance() {
		if (mInstance == null) {
			throw new IllegalStateException(
				"Must call init() before using SecuredClientDataStorage");
		}
	...
	public static void init(Context appContext,
		...
		if (mInstance != null) {
			Timber.tag(TAG).w("init called when there already is a non-null instance of the class");
			return;
		}

		setRecoveryHandler(recoveryHandler);
		mInstance = new SecuredClientDataStorage(appContext);
