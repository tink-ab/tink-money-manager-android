package se.tink.android.charts.piechart
...
import se.tink.android.charts.ui.LabelLayout
import se.tink.android.extensions.childOrNull
import se.tink.android.extensions.children
...
class PieChartView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    init {
        ...
        maxRadiusPercent = a.getFloat(R.styleable.PieChartView_max_radius_percent, 1f)
        thicknessRatio = a.getFloat(R.styleable.PieChartView_thickness_percent, 0.25f)
        a.recycle()
    }
    ...
    companion object {
        ...
        val ANGLE: Property<PieChartView.PieChartSegmentView, Float> =
            object : Property<PieChartView.PieChartSegmentView, Float>(Float::class.java, "angle") {
                override fun get(item: PieChartView.PieChartSegmentView) = item.angle
                override fun set(item: PieChartView.PieChartSegmentView, value: Float) {
                    item.angle = value
                }
            }

        val START_ANGLE: Property<PieChartView.PieChartSegmentView, Float> =
            object : Property<PieChartView.PieChartSegmentView, Float>(Float::class.java, "startAngle") {
                override fun get(item: PieChartView.PieChartSegmentView) = item.startAngle
                override fun set(item: PieChartView.PieChartSegmentView, value: Float) {
                    item.startAngle = value
                }
            }

        val COLOR: Property<PieChartView.PieChartSegmentView, Int> =
            object : Property<PieChartView.PieChartSegmentView, Int>(Int::class.java, "color") {
                override fun get(item: PieChartView.PieChartSegmentView) = item.color
                override fun set(item: PieChartView.PieChartSegmentView, value: Int) {
                    item.color = value
                }
            }
    }
