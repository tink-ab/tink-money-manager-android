...
import com.tink.moneymanagerui.statistics.piechart.addBackSegment
import com.tink.moneymanagerui.statistics.piechart.addSegments
...
//                }
                StatisticType.INCOME -> replaceWithDetailsFragment(
                    ChartDetailsPagerFragment.newInstance(
                        ChartType.INCOME
                    ),
                    page
