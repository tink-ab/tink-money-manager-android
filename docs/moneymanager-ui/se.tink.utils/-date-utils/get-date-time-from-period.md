...
[androidJvm]\
fun [getDateTimeFromPeriod](get-date-time-from-period.html)(period: Period): [LocalDateTime](https://developer.android.com/reference/kotlin/java/time/LocalDateTime.html)
