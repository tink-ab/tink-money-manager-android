...
| Name | Summary |
|---|---|
| [locale](locale.html) | [androidJvm]<br>var [locale](locale.html): [Locale](https://developer.android.com/reference/kotlin/java/util/Locale.html)? = null |
| [pattern](pattern.html) | [androidJvm]<br>var [pattern](pattern.html): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null |
| [timeZoneId](time-zone-id.html) | [androidJvm]<br>var [timeZoneId](time-zone-id.html): [ZoneId](https://developer.android.com/reference/kotlin/java/time/ZoneId.html)? = null |
