...
[androidJvm]\
class [LeftToSpendTransactionPagesLiveData](index.html)(val appExecutors: [AppExecutors](../../se.tink.android/-app-executors/index.html), val transactionService: TransactionService, val period: Period?) : [AbstractTransactionPagesLiveData](../-abstract-transaction-pages-live-data/index.html)
...
| | |
|---|---|
| [LeftToSpendTransactionPagesLiveData](-left-to-spend-transaction-pages-live-data.html) | [androidJvm]<br>fun [LeftToSpendTransactionPagesLiveData](-left-to-spend-transaction-pages-live-data.html)(appExecutors: [AppExecutors](../../se.tink.android/-app-executors/index.html), transactionService: TransactionService, period: Period?) |
