...
[androidJvm]\
inner class [InsightsDiffUtilCallback](index.html)(newItems: [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)&lt;Insight&gt;) : [DiffUtil.Callback](https://developer.android.com/reference/kotlin/androidx/recyclerview/widget/DiffUtil.Callback.html)
...
| | |
|---|---|
| [InsightsDiffUtilCallback](-insights-diff-util-callback.html) | [androidJvm]<br>fun [InsightsDiffUtilCallback](-insights-diff-util-callback.html)(newItems: [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)&lt;Insight&gt;) |
