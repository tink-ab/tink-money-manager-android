...
| [OverviewData](-overview-data/index.html) | [androidJvm]<br>class [OverviewData](-overview-data/index.html)(val statistics: [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)&lt;Statistics&gt;, val period: Period, val categories: CategoryTree, val currency: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) |
