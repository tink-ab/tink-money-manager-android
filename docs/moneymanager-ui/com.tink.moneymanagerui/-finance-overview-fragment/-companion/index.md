...
| [ARG_IS_TRANSACTION_DETAILS_ENABLED](-a-r-g_-i-s_-t-r-a-n-s-a-c-t-i-o-n_-d-e-t-a-i-l-s_-e-n-a-b-l-e-d.html) | [androidJvm]<br>const val [ARG_IS_TRANSACTION_DETAILS_ENABLED](-a-r-g_-i-s_-t-r-a-n-s-a-c-t-i-o-n_-d-e-t-a-i-l-s_-e-n-a-b-l-e-d.html): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html) |
