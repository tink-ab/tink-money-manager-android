...
| [AccountWithImage](-account-with-image/index.html) | [androidJvm]<br>data class [AccountWithImage](-account-with-image/index.html)(val account: Account, val iconUrl: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) |
...
| [OverviewAccountsTypeAccounts](-overview-accounts-type-accounts/index.html) | [androidJvm]<br>class [OverviewAccountsTypeAccounts](-overview-accounts-type-accounts/index.html)(accountType: Account.Type) : [OverviewAccountsMode](-overview-accounts-mode/index.html) |
