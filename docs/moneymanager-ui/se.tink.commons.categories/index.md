...
| Name | Summary |
|---|---|
| [getIcon](get-icon.html) | [androidJvm]<br>@[AttrRes](https://developer.android.com/reference/kotlin/androidx/annotation/AttrRes.html)<br>fun Category.[getIcon](get-icon.html)(): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html) |
| [graphColor](graph-color.html) | [androidJvm]<br>@[AttrRes](https://developer.android.com/reference/kotlin/androidx/annotation/AttrRes.html)<br>fun Category.[graphColor](graph-color.html)(): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html) |
| [iconBackgroundColor](icon-background-color.html) | [androidJvm]<br>@[AttrRes](https://developer.android.com/reference/kotlin/androidx/annotation/AttrRes.html)<br>fun Category.[iconBackgroundColor](icon-background-color.html)(): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html) |
| [iconColor](icon-color.html) | [androidJvm]<br>@[AttrRes](https://developer.android.com/reference/kotlin/androidx/annotation/AttrRes.html)<br>fun Category.[iconColor](icon-color.html)(): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html) |
