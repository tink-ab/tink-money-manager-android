...
[androidJvm]\
fun [formatCurrencyExactWithExplicitPositive](format-currency-exact-with-explicit-positive.html)(amount: Amount): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)
