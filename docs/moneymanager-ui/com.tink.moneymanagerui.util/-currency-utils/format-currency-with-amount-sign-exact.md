...
[androidJvm]\
fun [formatCurrencyWithAmountSignExact](format-currency-with-amount-sign-exact.html)(amount: Amount): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)
